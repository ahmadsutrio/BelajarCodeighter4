...
<head>
    ...
    <link href="<?= base_url() ?>/public/asset/vendor/fontawesome-free/css/all.min.css" rel="stylesheet"
        type="text/css">
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/js/bootstrap.bundle.min.js"></script>
    <link rel="stylesheet" href="https://cdn.datatables.net/1.13.6/css/dataTables.bootstrap5.min.css">
    <link href="<?//= base_url() ?>/public/asset/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
...
<body>
    ...
    <div class="container">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbarx">
                    ...
                    <ul class="navbar-nav ms-auto" style="z-index: 9;">
                        <li class="nav-item navtop navbar-active"><a class="nav-link"
                                href="<?= base_url(); ?>bendahara">Home</a></li>

                        <li class="nav-item navtop menu-active">
                            <a class="btn text-danger" href="app/login/logout.php"
        ...
        <nav class="navbar navbar-white bg-white navbar-expand fixed-bottom d-md-none d-lg-none d-xl-none">
            <ul class="navbar-nav nav-justified w-100">
                <li class="nav-item">
                    <a href="<?= base_url(); ?>/bendahara" class="nav-link">
    ...
    <div style="width:100%;display:inline-block;margin-top:-300px;background: #633bb8;z-index:-9999;">
        <img src="https://flashsoftindonesia.com/web/politik/assets/img/shape.png"
            style="float:right;width:400px;opacity:0.3;z-index:-9999;">
    </div>
    ...
    <!-- <script src="<?//= base_url() ?>/public/asset/vendor/datatables/jquery.dataTables.min.js">
    </script>
    <script src="<?//= base_url() ?>/public/asset/vendor/datatables/dataTables.bootstrap4.min.js">
    </script> -->

    <!-- Page level custom scripts -->
    <script src="<?//= base_url() ?>/public/asset/js/demo/datatables-demo.js"></script>
